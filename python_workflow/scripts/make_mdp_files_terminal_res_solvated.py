...
outdir = '../MDP/terminal_residue/solvated/fe_calcs'
mdpfiles = ['../MDP/templates/solvated/min_lambda_terminalres_X.mdp', '../MDP/templates/solvated/nvt_lambda_terminalres_X.mdp', '../MDP/templates/solvated/npt_lambda_terminalres_X.mdp', '../MDP/templates/solvated/production_lambda_terminalres_X.mdp']
lambdanr=20
...
for i in range(0, lambdanr):
    ...
    for mdpfile in mdpfiles:
        mdpfilename = os.path.join(outdir, Path(mdpfile).name.replace('_terminalres_X.', '_%s.' % i))
