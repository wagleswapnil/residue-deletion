...
outdir = '../MDP/terminal_residue/vacuum/fe_calcs'
mdpfiles = ['../MDP/templates/vacuum/min_lambda_terminalres_X.mdp', '../MDP/templates/vacuum/nvt_lambda_terminalres_X.mdp', '../MDP/templates/vacuum/production_lambda_terminalres_X.mdp']
lambdanr=20
