...
mdpfiles = ['../MDP/templates/min_edge1.mdp', '../MDP/templates/nvt_lambda_X.mdp', '../MDP/templates/npt_lambda_X.mdp', '../MDP/templates/production_lambda_X.mdp']
lambdanr=20

if not os.path.isdir(outdir): os.mkdirs(outdir, exist_ok=True)
